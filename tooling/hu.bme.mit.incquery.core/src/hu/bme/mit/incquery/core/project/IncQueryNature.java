package hu.bme.mit.incquery.core.project;
...
public class IncQueryNature implements IProjectNature {
	 ...
	 * IncQuery project.
	 */
	public static final String NATURE_ID = "hu.bme.mit.incquery.projectnature"; //$NON-NLS-1$
	public static final String BUNDLE_ID = "hu.bme.mit.incquery.core"; //$NON-NLS-1$
	public static final String MODEL_BUNDLE_ID = "hu.optxware.emf2viatra.core"; //$NON-NLS-1$
