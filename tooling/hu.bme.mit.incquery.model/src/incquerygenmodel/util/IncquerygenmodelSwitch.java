...
public class IncquerygenmodelSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case IncquerygenmodelPackage.INC_QUERY_GENMODEL: {
				IncQueryGenmodel incQueryGenmodel = (IncQueryGenmodel)theEObject;
				T result = caseIncQueryGenmodel(incQueryGenmodel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case IncquerygenmodelPackage.ECORE_MODEL: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Inc Query Genmodel</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Inc Query Genmodel</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIncQueryGenmodel(IncQueryGenmodel object) {
		return null;
	}
