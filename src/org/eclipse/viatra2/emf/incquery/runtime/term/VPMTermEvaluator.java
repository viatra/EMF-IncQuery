...
public class VPMTermEvaluator {
	public static String name(Object o)throws IncQueryRuntimeException{
	 ...
	 */
	public static Boolean and(Object op1, Object op2)throws IncQueryRuntimeException{
		
		if(op1 instanceof Boolean)
		{
			if(op2 instanceof Boolean)
				return ((Boolean)op1)&&((Boolean)op2);
			else throw new IncQueryRuntimeException(IncQueryRuntimeException.PARAM_NOT_SUITABLE_WITH_NO+"2");
		}
	 ...
	 */
	public static Boolean or(Object op1, Object op2)throws IncQueryRuntimeException{
		if(op1 instanceof Boolean)
		{
			if(op2 instanceof Boolean)
				return ((Boolean)op1)||((Boolean)op2);
	 ...
	 * @throws IncQueryRuntimeException
	 */
	public static Boolean xor(Object op1, Object op2)throws IncQueryRuntimeException{
		if(op1 instanceof Boolean)
		{
			if(op2 instanceof Boolean)
	 ...
	 * @throws IncQueryRuntimeException
	 */
	public static Boolean equals(Object op1, Object op2)throws IncQueryRuntimeException{
	 ...
	 * @throws IncQueryRuntimeException
	 */
	public static Boolean notEquals(Object op1, Object op2)throws IncQueryRuntimeException{
		return !(op1.equals(op2));
	}
	 ...
	 * @throws IncQueryRuntimeException
	 */
	public static Boolean lessThan(Object op1, Object op2)throws IncQueryRuntimeException{
	 ...
	 * @throws IncQueryRuntimeException
	 */
	public static Boolean greaterThan(Object op1, Object op2)throws IncQueryRuntimeException{
	 ...
	 * @throws IncQueryRuntimeException
	 */
	private static Boolean lessThanInner(Object op1, Object op2, int op1Pos, int op2Pos)throws IncQueryRuntimeException{
		if(op1 instanceof Integer)
		{
			...
			else throw new IncQueryRuntimeException(IncQueryRuntimeException.PARAM_NOT_SUITABLE_WITH_NO+op2Pos);
		}
		...
		else throw new IncQueryRuntimeException(IncQueryRuntimeException.PARAM_NOT_SUITABLE_WITH_NO+op1Pos);
	}
	 ...
	 * @throws IncQueryRuntimeException
	 */
	public static Boolean lessThanorEqual(Object op1, Object op2)throws IncQueryRuntimeException{
	 ...
	 * @throws IncQueryRuntimeException
	 */
	public static Boolean greaterThanorEqual(Object op1, Object op2)throws IncQueryRuntimeException{
	 ...
	 * @throws IncQueryRuntimeException
	 */
	private static Boolean lessThanorEqualInner(Object op1, Object op2, int op1Pos, int op2Pos) throws IncQueryRuntimeException{
		if(op1 instanceof Integer)
		{
			if(op2 instanceof Integer)
				return ((Integer)op1)<=((Integer)op2);
	 ...
	 * @throws IncQueryRuntimeException
	 */
	public static Object plus(Object op1, Object op2) throws IncQueryRuntimeException {
		...
		if (op1 instanceof String||op2 instanceof String) 
		{
			...
			else throw new IncQueryRuntimeException(IncQueryRuntimeException.PARAM_NOT_SUITABLE_WITH_NO+"2",termToBeEvaluated);*/
		} else if (op1 instanceof Double) 
		{ 
		...
		{ 
			...
			if(op2 instanceof Boolean)
				...
				throw new IncQueryRuntimeException(IncQueryRuntimeException.PARAM_NOT_SUITABLE_WITH_NO+"2");
		else throw new IncQueryRuntimeException(IncQueryRuntimeException.PARAM_NOT_SUITABLE_WITH_NO+"1");
	 ...
	 * @throws IncQueryRuntimeException
	 */
	public static Object minus(Object op1, Object op2) throws IncQueryRuntimeException {
	 ...
	 * @throws IncQueryRuntimeException
	 */
	public static Object multiply(Object op1, Object op2) throws IncQueryRuntimeException {
	 ...
	 * @throws IncQueryRuntimeException
	 */
	public static Object division(Object op1, Object op2) throws IncQueryRuntimeException {
		if (op1 instanceof Double) 
		{ 
			// Double and Integer permitted
			if (op2 instanceof Double)
	 ...
	 * @throws IncQueryRuntimeException
	 */
	public static Object remainder(Object op1, Object op2) throws IncQueryRuntimeException {
//		 Only for Integer! 
		if (op1 instanceof Integer) 
		{ 
			if (op2 instanceof Integer)
...
//***************************************converters*****************
	...
	/** Returns the Boolean value of the input parameter. Throws a IncQueryRuntimeException exception if it cannot be converted
	 * @param op1 the parameter to be converted
	 * @return the Boolean equivalent of the parameter
	 * @throws IncQueryRuntimeException
	 */
	public static Boolean toBoolean(Object op1) throws IncQueryRuntimeException{
	...
	/**Returns the integer value of the input parameter. Throws a IncQueryRuntimeException exception if it cannot be converted 
	 * @param op1 the parameter to be converted
	 * @return
	 * @throws IncQueryRuntimeException
	 */
	public static Integer toInteger(Object op1) throws IncQueryRuntimeException{
	...
	/**Returns the double value of the input parameter. Throws a IncQueryRuntimeException exception if it cannot be converted 
	 * @param op1 the parameter to be converted
	 * @return
	 * @throws IncQueryRuntimeException
	 */

	public static Double toDouble(Object op1) throws IncQueryRuntimeException{
