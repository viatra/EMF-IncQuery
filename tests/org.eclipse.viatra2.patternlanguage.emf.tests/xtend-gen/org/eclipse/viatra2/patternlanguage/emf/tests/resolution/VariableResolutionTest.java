    ...
    try {
      {
        ...
        final EClassifierConstraint constraint = ((EClassifierConstraint) _get_3);
    ...
    try {
      {
        ...
        EList<Constraint> _constraints = _get_2.getConstraints();
        Constraint _get_3 = _constraints.get(0);
        final EClassifierConstraint constraint0 = ((EClassifierConstraint) _get_3);
        ...
        final EClassifierConstraint constraint1 = ((EClassifierConstraint) _get_5);
        String _name = parameter.getName();
