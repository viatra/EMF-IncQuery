 ...
 * Note that the implementation relies on the correct implementation of the equals method of the type parameter's class.
 * 
 * @author Tamas Szabo
 *
 * @param <V> the type parameter of the element's stored in the union-find data structure
 */
public class UnionFind<V> {
	 ...
	 * 
	 * @param nodes the array of elements
	 ...
	 * 
	 * @param node the root node of the set
	 * @return the root element
	 */
	...
	/**
	 * Union by rank implementation of the two sets which contain x and y; 
	 * x and/or y can be a single element from the universe.
	 * 
	 * @param x set or single element of the universe
	 * @param y	set or single element of the universe
