 ...
 *******************************************************************************/
package org.eclipse.viatra2.compiled.emf.runtime.exception;

import org.eclipse.viatra2.gtasm.patternmatcher.incremental.rete.construction.RetePatternBuildException;

public class ViatraCompiledRuntimeException extends Exception{
	...
	public static String CONVERSION_FAILED = "Can not convert the term to the designated type";
	...
	public static String GETNAME_FAILED = "Cannot get 'name' attribute of the result";
	...
	public ViatraCompiledRuntimeException(String s) {
		super(s);
	}
	public ViatraCompiledRuntimeException(RetePatternBuildException e) {
