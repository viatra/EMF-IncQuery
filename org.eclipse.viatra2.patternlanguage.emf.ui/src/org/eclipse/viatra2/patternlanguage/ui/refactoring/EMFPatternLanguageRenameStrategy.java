...
public class EMFPatternLanguageRenameStrategy extends AbstractJvmModelRenameStrategy {
	...
	public static class Provider extends DefaultRenameStrategy.Provider {
		...
		public IRenameStrategy get(EObject targetElement, IRenameElementContext renameElementContext) {
			return new EMFPatternLanguageRenameStrategy(targetElement, getLocationInFileProvider(), jvmModelAssociations);
		}
	}
	
	protected EMFPatternLanguageRenameStrategy(EObject targetElement, ILocationInFileProvider locationInFileProvider,
