...
* generated by Xtext
*/
package org.eclipse.viatra2.gtasm.ui.refactoring;
...
public class PatternLanguageRenameStrategy extends AbstractJvmModelRenameStrategy {
	...
	public static class Provider extends DefaultRenameStrategy.Provider {
		...
		public IRenameStrategy get(EObject targetElement, IRenameElementContext renameElementContext) {
			return new PatternLanguageRenameStrategy(targetElement, getLocationInFileProvider(), jvmModelAssociations);
		}
	}
	
	protected PatternLanguageRenameStrategy(EObject targetElement, ILocationInFileProvider locationInFileProvider,
